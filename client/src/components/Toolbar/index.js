...
const Toolbar = () => {
  const{activeToolItem, changeToolHandler, undo, redo, saveCanvas} = useContext(boardContext);
  ...
  return (
    <div className={classes.container}>
      ...
      <div className={
        ...
        ><FaDownload/></div> 
        <div className={classes.toolItem} onClick={saveCanvas}>
          <FaSave />
        </div>
